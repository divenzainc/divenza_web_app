...
const successStories: SuccessStory[] = [
  {
    ...
    testimonial: "Working with Divenza felt like having an extension of our own team. They built our e-commerce platform from scratch, and the results speak for themselves. Sales doubled within the first quarter of launch.",
    author: "Jhon Rizane Pitter",
    role: "Director",
    color: "primary",
  },
  {
    id: 2,
    client: "Lanka Tech Solutions",
    logo: "LTS",
    industry: "Technology",
    challenge: "Managing multiple branches with disconnected systems causing delays and inefficiencies.",
    solution: "Implemented Ditech Cloud - our comprehensive business management solution with real-time tracking and centralized operations.",
    results: [
      "300% increase in operational efficiency",
      "60% reduction in manual processes",
      "Real-time data insights across all departments",
    ],
    testimonial: "Divenza transformed our entire digital infrastructure. Their team didn't just deliver a product—they understood our vision and made it reality. The attention to detail and commitment to excellence exceeded all expectations.",
    author: "Ramesh Kumar",
    role: "Founder",
    color: "secondary",
  },
  {
    ...
    testimonial: "The Ditech Cloud solution revolutionized how we manage our multi-branch operations. Real-time tracking, seamless integration, and incredible support. Divenza delivers what they promise—and then some.",
    author: "Sri Gobinath (Canada)",
    role: "Founder",
    color: "primary",
  },
  {
    id: 4,
    client: "Cinefilms Lanka",
    logo: "CL",
    industry: "Film Production",
    challenge: "Limited digital presence and difficulty reaching wider audiences beyond traditional theatrical releases in Sri Lanka's competitive film market.",
    solution: "Built a comprehensive digital marketing strategy with social media campaigns, trailer launches, and audience engagement across platforms to amplify film visibility.",
    results: [
      "3x increase in online audience reach",
      "60% growth in social media engagement",
      "Broader brand recognition across Sri Lanka",
    ],
    testimonial: "Their digital marketing strategies are nothing short of brilliant. Our brand visibility skyrocketed, and customer engagement reached levels we never thought possible. True partners in growth.",
    author: "Dr. Somaratne Dissanayake",
    role: "Film Director",
    color: "secondary",
  },
];
