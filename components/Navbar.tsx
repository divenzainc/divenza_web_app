...
const navItems: NavItem[] = [
  ...
  { label: 'Who We Are', href: '/about-us' },
  {
    ...
    href: '/services',
    children: [
      { label: 'Web Application Development', href: '/services', description: 'Grow your online presence' },
      { label: 'Mobile Apps', href: '/services', description: 'Advanced mobile applications' },
      { label: 'AI Automation', href: '/services', description: 'Automate your business processes' },
      { label: 'Digital Marketing', href: '/services', description: 'Grow your online presence' },
      { label: 'Social Media Marketing', href: '/services', description: 'Engage your audience effectively' },
      { label: 'Branding', href: '/services', description: 'Build a memorable brand identity' },
      { label: 'SEO', href: '/services', description: 'Rank higher on search engines' },
      { label: 'Custom Software', href: '/services', description: 'Tailored solutions for your needs' },
    ],
  },
  {
    label: 'Products',
